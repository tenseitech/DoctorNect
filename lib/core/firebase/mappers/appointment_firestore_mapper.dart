...
abstract final class AppointmentFirestoreMapper {
  ...
  static Map<String, dynamic> toMap(DoctorNectAppointmentRecord record,
    ...
    return {
      ...
      if (record.reviewId != null && record.reviewId!.isNotEmpty)
      ...
      if (record.patientRelation != null)
        'patientRelation': record.patientRelation,
      if (record.slotShareReason != null)
        'slotShareReason': record.slotShareReason,
