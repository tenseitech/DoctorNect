...
class LabCatalogRepository {
  ...
  Future<LabCatalog> fetchCatalog() async {
    ...
    if (!FirebaseBootstrap.isReady) {
      ...
      final ref = FirebaseFirestore.instance.collection(FirestorePaths.labCatalog).doc(_docId);
...
class LabCatalog {
  ...
  static LabCatalog fromMap(Map<String, dynamic> data) {
    ...
    try {
      ...
      return LabCatalog(
        ...
        slotPeriods: (data['slotPeriods'] as Map<String, dynamic>? ?? const {}).map(
  ...
  static LabTestItem _testFromMap(Map<String, dynamic> data) => LabTestItem(
        ...
        sampleType: SampleType.values.byName(data['sampleType'] as String? ?? 'blood'),
  ...
  static LabHealthPackage _packageFromMap(Map<String, dynamic> data) => LabHealthPackage(
