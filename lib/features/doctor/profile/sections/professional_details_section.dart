...
class ProfessionalDetailsSection extends StatefulWidget {
  ...
  @override
  State<ProfessionalDetailsSection> createState() =>
...
class _ProfessionalDetailsSectionState
  ...
  List<String> get _stateOptions {
    ...
    if (current != null &&
        current.isNotEmpty &&
        !IndianStates.all.contains(current)) {
  ...
  Future<void> _save() async {
    ...
    if (councilWasEditable && _councilNumber.text.trim().isNotEmpty) {
      _councilEditable =
          false; // FIXED: lock council number only after a confirmed save
    }
                            ...
                            DropdownButtonFormField<String>(
                              ...
                              decoration: RequiredFieldLabels.decorate(
                                InputDecoration(
                                  ...
                                  fillColor: _stateCouncilEditable
                                      ? null
                                      : AppColors.cardBgOf(context),
